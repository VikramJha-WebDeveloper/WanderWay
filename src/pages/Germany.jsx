...
const Germany = () => {
  ...
  const packeges = [
      {
        image: "/WanderWay/package images/Germany – Berlin.jpg",
        title: "Germany – Berlin",
        paragraph: "Discover historical landmarks like the Berlin Wall and Brandenburg Gate.",
        price: "$1500 USD"
      }
  ]
  return (
    <PackageSection>
        <PageHeading pageHeading="Germany"/>
